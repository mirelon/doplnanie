export function korpus() {
    return 'Správa z vyšetrenia:\n' +
        'Dieťa navštevuje ambulanciu klinickej logopédie od februára 2018 v pravidelných intervaloch 1krát za 4 týždne kvôli obojstrannej percepčnej strate sluchu, ktorá je od februára 2018 korigovaná na obidvoch ušiach načúvacími prístrojmi WIDEX.\n' +
        'Dieťa užíva načúvacie prístroje pravidelne, celodenne a primerane ich toleruje. Dieťa žije v úplnej rodine, má mladšieho súrodenca.\n' +
        '\n' +
        'Šimon prichádza na terapiu v doprovode matky,spolupráca je primeraná, sedí sám na stoličke.\n' +
        'V reči dieťaťa evidujeme vzhľadom k veku primeranú slovnú zásobu, morfologicko-syntaktická je toho času bez pozoruhodností.\n' +
        'Vo foneticko-fonologickej rovine evidujeme kompletný fonetický repertoár .Konsonant L dieťa používa na 60-70%, konsonant R tvorí distorzne - korekcia substitučnou metódou, fixácia konsonantu Š vo finálnej pozícií.\n' +
        '\n' +
        'Záver: Dieťa vo veku 5 rokov a 9 mesiacov, s obojstrannom percepčnou stratou sluchu, ktorá je od februára 20118 korigovaná načúvacími nástrojmi, t.č. používa WIDEX, t.č aj prevodová porucha sluchu ktoré dieťa toleruje primerane a užíva celodenne, pravidelne, s primeraným porozumením reči, s narušenou foneticko-fonologickou rovinou reči. Odporúčame naďalej pravidelnú návštevu logopedickej ambulancie, so zameraním na intenzívnu pravidelnú rečovú stimuláciu a rehabilitáciu a úlohy z logopedických sedení prevádzať v domácom prostredí.'
    +
        'Správa z vyšetrenia:\n' +
        'Dieťa navštevuje ambulanciu klinickej logopédie od apríla 2019 v pravidelných intervaloch 1krát za 4 týždne, kvôli špecificky narušenému vývinu reči pri základnej diagnóze ťažkej obojstrannú percepčnej poruche sluchu, ktorá je od februára 2017 korigovaná kochleárnym implantátom vpravo a od októbra 2018 korigovaná kochleárnym implantátom vľavo.  \n' +
        'Dieťa kochleárny implantát vľavo odmieta. Žije v neúplnej rodine s mamkou, má staršieho súrodenca, ktorý je zdravý. Navštevuje kolektív ŠMŠ Ľudová.\n' +
        '\n' +
        'Natália prichádza na terapiu v doprovode matky, pozornosť dieťaťa je oscilujúca. Počas vyšetrenia dieťa nadväzuje zrakový kontakt, sleduje tvár komunikačného partnera. Dieťa je pohybovo výrazne aktívne, prevláda motorický nekľud. Motivovať dieťaťa k dlhodobejším výkonom je náročné, aktívna pracovná výdrž je veľmi krátka vzhľadom k veku.\n' +
        '\n' +
        'Expresívna zložka reči: Dieťa sa s okolím dorozumieva prevažne na neverbálnej úrovni, používa posunky, gestá, mimiku, krik a sebaobsluhu na dosiahnutie svojich potrieb. Začína používať aktívne niekoľko významových zvukov a niekoľko jednoduchých slov, ktoré používa v správnom kontexte.\n' +
        'Snaha o komunikáciu je funkčná, vykazuje komunikačný zámer.\n' +
        '\n' +
        'Impresívna zložka reči: Sluchové vnímanie s nasadenými procesormi hodnotíme ako primerané v oblasti vnímania a rozlišovania zvukov okolia. Rozlišovanie zvukov reči je ešte výrazne obmedzené. Lingové hlásky dieťa v ambulancii deteguje a identifikuje. Verbálnym pokynom rozumie v spojitosti s gestami a posunkami, činnosti na obrázku rozumie len cez neverbálne pokyny a odzeranie. Počas dňa rozumie bežným denným frázam, ktoré sú spojené s dennými rutinami. Pasívny slovník je ešte výrazne limitovaný vzhľadom k veku.\n' +
        '\n' +
        'Verbálno-akustická pamäť dieťaťa je výrazne oslabená.\n' +
        'Oromotorika je stimulovaná. Kognitívne schopnosti hodnotíme orientačne veku neprimerané.\n' +
        'Morfologicko- syntaktická a foneticko-fonologická jazyková rovina aktuálne nie sú predmetom nášho hodnotenia.\n' +
        '\n' +
        '\n' +
        'Záver: Dieťa vo veku 6 rokov a 0 mesiacov so Špecificky narušeným vývinom reči pri základnej diagnóze  ťažkej obojstrannej percepčnej poruche sluchu, vzniknutou prelingválne, ktorá je od februára 2017 korigovaná kochleárnym implantátom vpravo a od októbra 2018 korigovaná kochleárnym implantátom vľavo, KI vľavo dieťa odmieta a t.č. neužíva ( je potrebné nové nastavenie KI),  s neprimeraným porozumením reči, s narušenou foneticko-fonologickou, morfologicko-syntaktickou a lexikálno-sémantickou rovinou reči, s primeranou pragmatickou jazykovou rovinou, s preferovaním neverbálnej komunikácie, pri porozumení reči sa spolieha na odzeranie.\n' +
        'Odporúčame naďalej pravidelnú návštevu logopedickej ambulancie, so zameraním na intenzívnu pravidelnú verbálno-auditívnu rehabilitáciu a úlohy z logopedických sedení prevádzať v domácom prostredí. Dieťa si vyžaduje zvýšenú starostlivosť. Odporúčame naďalej pravidelné sledovanie na foniatrickej a neurologickej ambulancii, v centre špeciálno-pedagogického poradenstva.\n' +
    ...
    +
        'Správa z vyšetrenia:\n' +
        'Dieťa navštevuje ambulanciu klinickej logopédie od novembra 2018 v pravidelných intervaloch, 1x za 4 týždne, kvôli oneskorenému a následne narušenému vývinu reči. Dieťa žije v neúplnej rodine, má dvoch súrodencov a na vyšetrenie prichádza v sprievode matky. Dieťa od septembra 2019 navštevuje kolektív rovesníkov MŠ.\n' +
        'V ambulancii ochotne spolupracuje, sedí za stolom, plní pokyny a inštrukcie. Zrakový kontakt nadväzuje spontánne. Pozornosť je na dobrej úrovni. Matka je počas terapie prítomná v miestnosti. Dieťa má primerané porozumenie verbálnej reči. Rozumie bežným inštrukciám, ktoré sú spojené s denným režimom a rituálmi. Obsahovo náročnejším dejovým  líniám nerozumie komplexne, stráca sa vo význame. Pasívna slovná zásoba je chudobnejšia vzhľadom k veku.\n' +
        'Dieťa komunikuje verbálnou rečou tvorenou do prevažne jednoslovných a dvojslovných jednoduchých agramatických viet. Aktívna slovná zásoba je chudobná vzhľadom k veku. Jednotné a množné číslo po nácviku na terapeutických sedeniach dieťa tvorí správne. Deficity zaznamenávame pri tvorbe akuzatívu podstatných mien a v priestorovej a časovej orientácii.  Foneticko-fonologická rovina je výrazne narušená vzhľadom k veku. Kognitívne schopnosti počas terapie hodnotíme orientačne na priemernej úrovni. Oromotorika je trénovaná, na dobrej úrovni.\n' +
        '\n' +
        'Záver: Dieťa vo veku 5 rokov a 3 mesiace s oneskoreným a následne narušeným vývinom reči, s primeraným porozumením verbálnej zložky,s primeranou pragmatickou jazykovou rovinou, s narušeným a oneskoreným vývinom lexikálno-sémantickej, morfologicko-syntaktickej a foneticko-fonologickej jazykovej roviny. Dieťa počas terapie spolupracuje primerane veku, kognitívne schopnosti dieťaťa sú orientačne na primeranej úrovni. Hra je funkčná. Odporúčame naďalej pravidelné návštevy logopedickej ambulancie, intenzívnu stimuláciu psychomotorického vývinu, návštevu psychologickej ambulancie. Odporúčame dieťa zaradiť do kolektívu rovesníkov MŠ.'
    +
        'Správa z vyšetrenia: Dieťa navštevuje ambulanciu klinickej logopédie od septembra 2018 v nepravidelných intervaloch kvôli oneskorenému a následne narušenému vývinu reči, poukázané pediatrom.\n' +
        'Dieťa z prvej gravidity, pôrod sekciou, po pôrode kriesené, AS 4/7, hyperbilirubinémia, fototerapia, má deformitu ľavej ušnice. Ranný PMV vývin bol oneskorený, chodiť začal v 22 mesiacoch. Prvé slová začal používať po treťom roku.\n' +
        'Dieťa žije v úplnej rodine, má dvoch mladších súrodencov. Rodina žila do roku 2016 na Slovensku, od roku 2016 do 2018 žili v Španielsku, kde Lukáško vyrastal v bilingválnom prostredí. Potom sa znova vrátili na Slovensko. Lukáško rozumel a sčasti ešte rozumie španielsky a hovorí slovensko-anglicko-španielskym jazykom. Lukáško chodí do kolektívu rovesníkov MŠ od roku 2018. Navštevuje pravidelne liečebnú pedagogiku.\n' +
        'Na terapiu prichádza Lukáško  v doprovode rodiča, rodič je prítomný na terapii. Spočiatku bol Lukáško mierne tenzný, bojazlivý, neskôr si postupne vytvoril dôveru k terapeutovi, t.č. je dobre emocionálne ladený, spolupracuje ochotne a primerane. V úvodnej časti terapie koncentrácia je na dobrej úrovni.  V druhej časti terapie je sústredenie prchavé, pozornosť postupne oslabuje, zvyšuje sa motorický nekľud.\n' +
        '\n' +
        'Impresívna zložka reči: Porozumenie bežnej dennej konverzácie je primerané veku. Rozumie a vykoná dvojstupňové inštrukcie. Viacstupňovým a zložitejším logicko-gramatickým prehovorom a pri nedostatočnej koncentrácii nerozumie úplne celému kontextu. Dieťa vyrastalo v dvojjazyčnom prostredí. a dôležité rečové vývinové obdobie bolo formované dvoj až trojjazyčným prostredím.\n' +
        '\n' +
        'Expresívna zložka reči: Lukáško komunikuje verbálnou rečou tvorenou do 3-4 slovných viet. Komunikácia je funkčná, slúži na výmenu informácií. Zrozumiteľnosť jeho verbálneho prejavu je pre okolie primeraná. Slovná zásoba je mierne oslabená vzhľadom k veku.\n' +
        'Tvorí dysgramatické vety s chybami vo flexii, občas použije nesprávnu koncovku pri skloňovaní.  Foneticko-fonologická rovina je narušená. Narušená je artikulácia hlások L a R. Zopakuje bez chyby 3 čísla, 3 slová. T.č. je Lukáško zacvičený do tréningu fonematického uvedomovania podľa Eľkonina: zvláda určiť prvú hlásku v slove a poslednú spoluhlásku v slove, učí sa identifikovať hlásky v otvorenej slabike. Úroveň fonematického sluchu, sluchovej pozornosti a primárnej sluchovej pamäti je vzhľadom k veku výrazne oslabená.\n' +
        'Úroveň oromotoriky je naďalej mierne dyspraktická.\n' +
        '\n' +
        'Záver: Dieťa vo veku 7 rokov a 2 mesiace s oneskoreným a následne narušeným vývinom reči, medzi 3 a 5 rokom dieťaťa rečový vývin dieťaťa dva roky intenzívne formovaný bilingválnym prostredím, s primeranou pragmatickou jazykovou rovinou, s mierne oslabeným porozumením verbálnej reči, s mierne oslabenou L-S rovinou, s mierne narušenou M-S rovinou, s oslabenou F-F rovinou, s oslabeným fonematickým sluchom a primárnou sluchovou pamäťou. Pozornosť oslabená, dieťa sa kvalitne sústredí na proces učenia krátku dobu vzhľadom k veku. Kognitívne schopnosti sú orientačne primerané.\n' +
        'Odporúčame zaradiť dieťa do prvého ročníka pre deti s narušenou komunikačnou schopnosťou.'
    +
        'Správa z vyšetrenia: Dieťa navštívilo ambulanciu klinickej logopédie prvýkrát v júni 2020 kvôli oneskorenému vývinu reči v expresívnej a impresívnej zložke reči. Dieťa je z prvej fyziologickej gravidity, narodené predčasne 3 týždne pred termínom. Dieťa vyrastá v bilingválnom prostredí, kolektív rovesníkov MŠ nenavštevuje.\n' +
        '\n' +
        'Mamka bola počas vyšetrenia prítomná v ambulancii. Dieťa je počas vyšetrenia dobre emocionálne ladené, nechá sa motivovať hračkami. Sedí samostatne za stolom, má tendenciu odbiehať od zadaných úloh, po upozornení sa vráti k úlohe a dokončí ju. V kontakte prevládajú prevažne subjektívne záujmy dieťaťa. Prekurzory vývinu reči ako očný kontakt dieťa udrží len krátkodobo. Motorická a verbálna imitácia je prítomná. Výmena rolí a spoločná pozornosť je krátkodobá, dieťa dokáže udržať výmenu rolí len na úrovni piatich výmen. Žiadosť dieťa vyjadruje gestom.\n' +
        'Porozumenie reči nie je primerané veku dieťaťa, evidujeme ho na kontextovej úrovni, rozumie rutinám.\n' +
        '\n' +
    ...
    +
        'Správa z vyšetrenia: Dieťa navštívilo ambulanciu klinickej logopédie prvýkrát v júni 2020 kvôli oneskorenému vývinu reči v expresívnej a impresívnej zložke reči. Dieťa je z prvej fyziologickej gravidity, narodené predčasne 3 týždne pred termínom. Dieťa vyrastá v bilingválnom prostredí, kolektív rovesníkov MŠ nenavštevuje.\n' +
        '\n' +
        'Dieťa prichádza na stretnutie s mamkou, mamka bola na prvom vyšetrení prítomná v ambulancii. Dieťa je počas vyšetrenia dobre emocionálne ladené, nechá sa motivovať hračkami. Sedí samostatne za stolom, má tendenciu odbiehať od zadaných úloh, po upozornení sa vráti k úlohe a dokončí ju. V kontakte prevládajú prevažne subjektívne záujmy dieťaťa. Prekurzory vývinu reči ako očný kontakt dieťa udrží len krátkodobo. Motorická a verbálna imitácia je prítomná. Výmena rolí a spoločná pozornosť je krátkodobá, dieťa dokáže udržať výmenu rolí len na úrovni piatich výmen. Žiadosť dieťa vyjadruje gestom.\n' +
        'Porozumenie reči nie je primerané veku dieťaťa, dieťa rozumie základným predmetom dennej potreby, pozná hračky, zvieratá, základné jedlo, rozumie bežným činnostiam, ktoré súvisia s denným režimom a rituálmi. evidujeme porozumenie na kontextovej úrovni, rozumie rutinám.\n' +
        'Aktívna slovná zásoba je vzhľadom k veku obmedzená. Dieťa používa vzhľadom k veku obmedzené množstvo podstatných mien a slovesá sa v aktívnej slovnej zásobe dieťaťa neobjavujú, v komunikácií ich vyjadruje gestom. Ďalšie slovné druhy dieťa nepoužíva.\n' +
        '\n' +
        'Dieťa komunikuje gestami, verbálny prehovor dieťaťa je na úrovni prirodzených zvukov. V expresii dieťaťa sa objavujú aj suplementárne spojenia gesta a slova, gesta a gesta.\n' +
        'Morfologicko-syntaktická a foneticko-fonologická jazyková rovina toho času nie sú predmetom nášho hodnotenia.\n' +
        'Oromotorické schopnosti sú oslabené. Pernoperný uzáver nie je dostatočný, prítomné je infantilné prehĺtanie a interdentálne postavenie jazyka. Dieťa toho času pije mlieko z dojčenskej fľaše.\n' +
        '\n' +
        '\n' +
        'Záver: dieťa vo veku 2,11 r. s oneskoreným vývinom reči v expresívnej a v impresívnej zložke reči, s podpriemerne rozvinutou aktívnou slovnou zásobou vzhľadom k veku, s dobrými imitačnými schopnosťami, s neprimeraným správaním pri neuspokojení subjektívnych potrieb.\n' +
        'Odporúčame dodržiavať komunikačné stratégie (mamka poučená),dať dieťaťu dôvod na komunikáciu odporúčame rozvíjať porozumenie reči a lexikálno-sémantickú jazykovú rovinu, rozvíjať kognitívne schopnosti dieťaťa, odstrániť dojčenskú fľašu, zlepšovať pozornosť.\n' +
    ...
    +
        'Správa z vyšetrenia: dieťa navštevuje ambulanciu klinickej logopédie 1krát za mesiac v pravidelných intervaloch od februára 2020, kvôli vývinovej jazykovej poruche. Na stretnutie prichádza s mamkou, mamka je prítomná v ambulancii počas vyšetrenia. Dieťa od septembra 2020 navštevuje prípravný ročník ZŠ, troch súrodencov.\n' +
        'Dieťa po motivácií sleduje a plní pokyny vyšetrujúceho. Kontakt dieťa po motivácií nadviaže, očný kontakt je oscilujúci. Dieťa sa vyjadrujeme verbálnou rečou, ktorá je pre počúvajúceho v známom kontexte diskrétne nezrozumiteľná.\n' +
        'V rámci pragmatickej jazykovej roviny evidujeme dieťa ako komunikačného partnera, ktorého komunikácia je závislá od komunikačného prostredia, v ktorom sa dieťa nachádza. Anna Mária je slabší komunikačný partner, so známymi osobami vedie konverzáciu, ak je v neznámom prostredí pri riadených úlohách neúspešná, prejavuje sa zvýšenou emocionalitou.\n' +
        'Lexikálno-sémantickú jazykovú rovinu evidujeme vzhľadom na vek dieťaťa ako neprimeranú, v reči dieťaťa neevidujeme všetky slovné druhy, prítomnosť tvorenia predložkových väzieb je narušená, spojky a zámená používa dieťa obmedzene. Podľa obsahu dieťa tvorí všetky typy viet, podľa zložitosti prevládajú jednoduché vety, ale vyskytujú sa aj priraďovacie, niekedy podraďovacie súvetia. V aktívnej slovnej zásobe sa vyskytujú anglické slová vzhľadom na vystavovanie dieťaťa tabletu.\n' +
        'V produkcii dieťaťa evidujeme prítomné dysgramatizmy, v predložkových väzbách dieťa zlyháva aj na úrovni predložiek NA, DO, V. Jazykový cit dieťaťa je oslabený. Produkcia slovies je prevažne v neurčitku. Rody a pády dieťa nevie vždy s určitosťou vyjadriť.\n' +
        'V rámci foneticko-fonologickej jazykovej roviny evidujeme nekompletný fonetický repertoár. Konsonanty L, R dieťa tvorí distorzne.\n' +
        '\n' +
        'Impresia dieťaťa je rozvinutá na viacslovnú úroveň, na úrovni zložitejších logicko-gramatických štruktúr je narušená. Má ťažkosti porozumieť priestorovej orientácií, stupňovaným prídavným menám, zložitejším predložkovým väzbám nerozumie.\n' +
        'Silnou stránkou dieťaťa sú neverbálne aktivity a kreslenie.\n' +
        'Verbálno-akustická pamäť dieťaťa je výrazne oslabená, zapamätá si tri prvky, pri štyroch sa už mýli.\n' +
        'Prebieha nácvik hláskovej analýzy prvej a poslednej hlásky v slove.\n' +
        'Priestorová orientácia dieťaťa je oslabená.\n' +
        'Motoriku artikulačných orgánov evidujeme bez pozoruhodností.\n' +
        'Kognitívne schopnosti dieťaťa sú orientačne v pásme širšej normy.\n' +
        '\n' +
        'Záver: dieťa vo veku 6 rokov a 8 mesiacov s vývinovou jazykovou poruchou, s lexikálno-sémantickou jazykovou rovinou neprimeranou k veku, s deficitnou morfologicko-syntaktickou jazykovou rovinou, s nekompletným fonetickým repertoárom, s oslabenou verbálno-akustickou pamäťou.\n' +
        'T.č. je logopedická terapia zameraná najmä na rozvoj aktívnej slovnej zásoby, tvorby a predlžovania viet, rozvoj porozumenia zložitejších gramatických inštrukcií. Zameriavame sa na terapiu deficitu krátkodobej akusticko-verbálnej pamäti, odporúčame prispôsobenie komplexnosti prehovoru úrovni porozumenia reči dieťaťa, opakovanie a preformulovanie prehovoru, ak dieťa nerozumie, využívanie iných komunikačných prostriedkov na podporu vybavenia informácie, opakovanie situácií, v ktorých sa dané slová používajú, opakovanie slov, verbálno-vizuálnej asociácie, kognitívne úlohy, tréning oromotorických schopností, nácvik hláskovej analýzy a syntézy. Ďalej odporúčame ponúkať dieťaťu rozprávky v slovenskom jazyku a rozvíjať naratívne schopnosti dieťaťa, rozvíjať morfosyntaktické uvedomovanie dieťaťa, rozvoj predložkových väzieb a priestorovej orientácie. Pri komunikácií s dieťaťom odporúčame využívať komunikačné stratégie o ktorých bola mamka dieťaťa poučená.\n' +
        'Na základe vyššie uvedeného odporúčame zotrvať v logopedickej starostlivosti a zadané úlohy na stimuláciu vývinu reči dieťaťa vykonávať aj v domácom prostredí.'
    +
        'Správa z vyšetrenia: Dieťa navštevuje pravidelne ambulanciu klinickej logopédie 1krát do mesiaca od októbra 2019 kvôli oneskorenému a následne narušenému vývinu reči v expresívnej a čiastočne aj impresívnej zložke reči.\n' +
        'Dieťa žije v úplnej rodine, má mladšieho brata, navštevuje kolektív rovesníkov MŠ s dobrou adaptáciou podľa rodičov.\n' +
        'Dušan je slabý komunikačný partner. Počas vyšetrenia je spolupráca sťažená, spočiatku je dieťa výrazne tenzné, odmieta spoluprácu, neskôr limitovane spolupracuje, má záujem o autá.\n' +
        'Impresívna zložka reči:\n' +
        'Dušanko rozumie bežným jednoduchým pokynom: zatvor, podaj mi, obleč sa, vyber... Na požiadanie podá  bežné predmety a hračky, rozumie základným činnostiam. Zrakový kontakt nadväzuje prirodzene, ale musí si s cudzou osobou dlho vytvárať priateľský vzťah. Podľa mamky rozumie bežným denným rituálnym frázam, ktoré sú spojené s denným režimom. Porozumenie obsahovo náročnejších inštrukcií nemôžeme hodnotiť, spolupráca dieťaťa je ešte výrazne limitovaná.\n' +
        'Expresívna zložka reči:\n' +
        'Dieťa komunikuje jednoduchou verbálnou rečou tvorenou do  jedno-dvojslovných viet. Podľa mamky občas použije v základnom tvare agramatickú trojslovnú vetu. Používa aj neverbálnu komunikáciu k dosiahnutiu svojich potrieb. U dieťaťa evidujeme komunikačný zámer, jednoduchá komunikácia je funkčná. Podľa mamky sa lexikálno-sémantická jazyková rovina mierne rozvíja, ale  je podpriemerná vzhľadom k veku. Dieťa pozná písmená, niektoré farby pomenuje v anglickom jazyku, u dieťaťa evidujeme prítomnosť jednoduchého globálneho čítania. Verbálno-akustická pamäť je výrazne oslabená.\n' +
        'V rámci morfologicko-syntaktickej jazykovej roviny dieťa nepoužíva jednotné a množné číslo a nepoužíva akuzatív podstatných mien, nepoužíva predložkové väzby.\n' +
        'Foneticko-fonologická jazyková rovina zatiaľ nie je predmetom nášho hodnotenia.\n' +
        'Kognitívne schopnosti sú orientačne oslabené.\n' +
        'Oromotoriku pre slabú spoluprácu dieťaťa nemôžeme hodnotiť.\n' +
        'Podľa mamky je sebaobsluha v domácom prostredí na dobrej úrovni, v kolektíve rovesníkov dieťa odmieta sebaobslužné činnosti.\n' +
        '\n' +
        'Záver: Dieťa vo veku 4 roky a 3 mesiace, s oneskoreným a následne narušeným vývinom reči, s mierne oslabenou impresívnou zložkou reči a s narušenou expresívnou zložkou reči s primeranou pragmatikou jazykovou rovinou, s podpriemernou pasívnou a aktívnou slovnou zásobou vzhľadom k veku, s podpriemernou morfologicko-syntaktickou jazykovou rovinou, s neprimeraným správaním vzhľadom k veku počas terapie ( v úvode výrazná tenzia ) . Odporúčame dodržiavať komunikačné stratégie (mamka poučená), odporúčame rozvíjať L-S jazykovú rovinu, rozvíjať porozumenie reči,rozvíjať podľa pokynov flexiu a syntax, rozvíjať kognitívne schopnosti a zlepšovať pozornosť. Odporúčame pravidelnú a intenzívnu rečovú rehabilitáciu a návštevu kolektívu rovesníkov. Odporúčame psychologické a liečebno pedagogické vyšetrenie a sledovanie. '
    +
        'Diagnóza: F840 - Detský autizmus\n' +
        'Správa z vyšetrenia: dieťa navštevuje ambulanciu klinickej logopédie od októbra 2019 v nepravidelných intervaloch kvôli primárnej diagnóze detský autizmus. Dieťa žije v úplnej rodine, navštevuje kolektív rovesníkov MŠ. Dieťa na stretnutie prichádza v doprovode mamky, očný kontakt neudržiava, je sledovaný na neurologickej, hematologickej, metabolickej, imunoalergologickej ambulancii.\n' +
        'Počas vyšetrenia je spolupráca dieťaťa riadená subjektívnymi záujmami dieťaťa. Má problém so stravou - obmedzený repertoár jedál, prítomné je sebapoškodzovanie, agresívne prejavy. Rád sa hrá selektívne. Janík je selektívny, hypersenzitívny, zapcháva si uši, vadí mu vysávač a mixér.\n' +
        'Impresívna zložka reči:\n' +
        'Porozumenie reči dieťaťa je rozvinuté na viacslovnú úroveň. Porozumenie viacstupňovým logicko-gramatickým štruktúram je susp. narušené.\n' +
        'Expresívna zložka reči:\n' +
        'Dieťa sa s okolím dorozumieva verbálnou rečou. V aktívnej slovnej zásobe dominujú fluentné viacslovné prehovory, ktoré dieťa produkuje v ruskom jazyku. Janík je vystavený rozprávkam v ruskom jazyku. Pragmatická jazyková rovina je vzhľadom na vek narušená, dieťa na otázky neodpovedá adekvátne.  \n' +
        'V komunikácií dieťaťa sa vyskytuje echolalická produkcia, vyskytujú sa idiosynkratické výrazy. Na verbálne výrazy reaguje selektívne. Pozná všetkých dinosaurov. Lexikálno-sémantická jazyková rovina a morfologicko-syntaktická jazyková rovina sú primerané. Foneticko-fonologická jazyková rovina je vzhľadom k veku narušená. Konsonant L dieťa tvorí distorzne.\n' +
        'Oromotorika je oslabená. Elevácia jazyka je obmedzená.\n' +
        '\n' +
        'Záver: Dieťa vo veku 5 rokov a 4 mesiace, s narušeným vývinom reči pri primárnej diagnóze detský autizmus. Janík je dieťa s  neprimeranou pragmatikou jazykovou rovinou, s aktívnou slovnou zásobou primeranou vzhľadom k veku, s primeranou morfologicko-syntaktickou jazykovou rovinou, s neprimeraným správaním vzhľadom k veku v domácom prostredí .\n' +
        'Odporúčame vystavovať dieťa slovenskému jazyku, obmedziť sledovanie ruských rozprávok, rozvíjať porozumenie reči, rozvíjať kognitívne schopnosti a zlepšovať pozornosť.\n' +
        'Na základe vyššie uvedeného odporúčame stav dieťaťa kompenzovať priznaním statusu ZŤP s príslušnými náležitosťami. Tento stav odporúčame kompenzovať priznaním príspevku na kúpu osobného motorového vozidla a príspevku na individuálnu prepravu, keďže dieťa navštevuje MŠ s nutným dochádzaním osobným motorickým vozidlom.'
    +
        'Správa z vyšetrenia: dieťa navštívilo ambulanciu klinickej logopédie 1krát v septembri na odporúčanie neurológia kvôli oneskorenému vývinu reči v expresívnej a čiastočne aj impresívnej zložke reči.  \n' +
        'Dieťa žije v úplnej rodine, kolektív rovesníkov MŠ nenavštevuje.\n' +
        'Tomáško je slabý komunikačný partner. Počas vyšetrenia je spolupráca sťažená, spočiatku je dieťa výrazne instabilné, odmieta spoluprácu, neskôr limitovane spolupracuje, sedí za stolíkom, dokončí úlohu, príkazy plní.\n' +
        'Impresívna zložka reči:\n' +
        'Tomáško rozumie bežným jednoduchým pokynom, situačné porozumenie je susp. primerané. Na požiadanie podá  bežné predmety a hračky, rozumie základným činnostiam. Zrakový kontakt nadväzuje prirodzene, ale je krátkodobý. Podľa mamky rozumie bežným denným rituálnym frázam, ktoré sú spojené s denným režimom. Porozumenie obsahovo náročnejších inštrukcií nemôžeme hodnotiť, spolupráca dieťaťa je ešte limitovaná.\n' +
        'Expresívna zložka reči:\n' +
        'Dieťa komunikuje jednoduchou verbálnou rečou tvorenou prevažne na úrovni prirodzených zvukov, objavuje sa zrod 2 slovných výpovedí - spojenie zvuku a gesta, spojenie gesta a gesta. V aktívnej slovnej zásobe dieťaťa sa začínajú objavovať podstatné mena v nominatíve singuláru. Tomáško používa aj neverbálnu komunikáciu k dosiahnutiu svojich potrieb. U dieťaťa evidujeme komunikačný zámer, jednoduchá komunikácia je funkčná. Podľa mamky sa aktívna slovná zásoba mierne rozvíja, ale je podpriemerná vzhľadom k veku.\n' +
        'Morfologicko-syntaktická jazyková rovina a foneticko-fonologická jazyková rovina zatiaľ nie sú predmetom nášho hodnotenia.\n' +
        'Kognitívne schopnosti sú orientačne oslabené.\n' +
        'Oromotoriku pre slabú spoluprácu dieťaťa nemôžeme hodnotiť.\n' +
    ...
    //     '\n' +
    //     'Osobná anamnéza: Tehotenstvo prebehlo bez komplikácií, pôrod bol spontánny, fyziologický, záhlavím. P. v. 3800 g, P. dĺ. 51 cm, dojčený bol do 6. mesiaca. Prekonal bežné detské ochorenia, hospitalizovaný nebol. Symptómy súvzťažných druhov NKS, prípadne iných ochorení a narušení matka neuvádza.\n' +
    //     '\n' +
    //     'Scholarita: Dieťa navštevovalo materskú školu v mieste bydliska od troch rokov. V súčasnosti navštevuje prvý ročník základnej školy v mieste bydliska. Triedny kolektív je od začiatku školskej dochádzky nezmenený, s počtom žiakov 26. Matka uvádza sporadické problémy s výsmechom zo strany spolužiakov ( niekedy sa ho pýtajú „prečo kokce“ ). Triedna učiteľka je k problému dysfluencie žiaka tolerantná, podľa slov matky eliminuje slovné odpovede žiaka pred celou triedou, najmä v obdobiach zhoršenia plynulosti reči - na začiatku školského roka ( matka po konzultácii s logopédkou CD SZU informovala o dysfluencii dieťaťa učiteľku ešte pred začatím školskej dochádzky ). A.B. je kolektívom spolužiakov síce akceptovaný, ale veľmi sa nepresadzuje, ani sa často verbálne neprejavuje.\n' +
    //     '\n' +
    //     'Patogenéza: Matka uvádza, že u A.B. sa prvé slová začali objavovať až okolo 3. roku života – napr. vo/voda; pi/piť. Po 4. roku dieťa postupne začalo tvoriť 2 – slovné vety. Slovná zásoba dieťaťa je nižšia, neprimeraná veku, ťažkosti sa prejavujú v pomenovaní (vo vybavení si) bežných slov, zvierat, vecí bežného použitia. Sporadicky sa v reči dieťaťa vyskytujú dysgramatizmy a nedostatky je možné pozorovať aj v syntaktickej zložke spontánneho prehovoru. Porozumenie hovorenej reči je zachované, splní aj zložitejšiu verbálnu inštrukciu.\n' +
    //     '\n' +
    //     '     Rodičia taktiež uvádzajú, že v minulosti (približne pred 2 rokmi) s dieťaťom začali navštevovať logopedickú ambulanciu v mieste bydliska, kde bola kvôli dyslálii dieťaťa realizovaná korekcia sigmatizmu a rotacizmu. Nakoľko sa po dlhšom čase nedarilo tento problém odstrániť, bola po konziliárnom vyšetrení na pracovisku chirurgie realizovaná frenulotómia. Po tomto zákroku A.B. odmietal pokračovať v logopedickej terapii korekcie dyslálie a rodičia z týchto dôvodov terapiu prerušili. V súčasnosti pretrváva nekonštantný rotacizmus, u dieťaťa sú prítomné artikulačné deficity v oblasti špecifických asimilácií. Oromotorika je v rámci izolovaných pohybov v norme, deficity je možné pozorovať v motorických sekvenciách. Fonematická diferenciácia je v norme, diskriminácia dlhej – krátkej, znelej – neznelej, mäkkej – tvrdej hlásky je A.B. izolovane rozlišovaná bez ťažkostí. Spontánny prehovor dieťaťa je v oblasti melódie a prízvuku reči charakterizovaný nepoužívaním dištinktívnych príznakov foném MJ – suspektná verbálna dyspraxia. Tempo reči je zvýšené / kolísavé, pauzy ( najmä v rámci slova ) tvorené nesprávne. Hlas je tvorený s námahou, s tvrdými hlasovými začiatkami, prítomné je kolísanie tónovej výšky. Rezonancia je mierne zvýšená v zmysle hypernazality.\n' +
    //     '\n' +
    //     '     Terapia balbuties u A.B. v minulosti nebola realizovaná.\n' +
    //     '\n' +
    //     '     Prvopočiatky dysfluencie dieťaťa uvádza matka v období na konci 4. roku života, v období predškolského veku. Zajakavosť vznikala postupne, prvá ju evidovala matka. Prvými symptómami boli repetície kratších slov a častí slov najčastejšie na prvej slabike, najmä v situáciách, keď chcel A.B. rodičom niečo rýchlo povedať. Matka na dysfluenciu reagovala upozorňovaním aby neplynulé slovo ešte raz zopakoval, resp. aby sa poriadne nadýchol, kým začne hovoriť. Postupne sa v reči začali objavovať prolongácie (trvajúce spočiatku 1-2 sekundy) a prejavy nadmernej námahy (matka uvádza neprirodzené prižmurovanie očí, vraštenie čela počas prekonávania bloku spojené s dvíhaním obočia, občas už aj sprevádzané s výskytom blokov v reči). Frekvencia a stupeň symptómov sa podľa rodičov stupňovali najmä pri komunikácii s cudzími ľuďmi alebo v situáciách, keď chcel niečo rýchlo povedať alebo oznámiť (pri pozitívne aj negatívne prežívaných emóciách). Porovnanie zhoršenia resp. zlepšenia úrovne plynulosti reči dieťaťa v školskom prostredí nevedia zhodnotiť.\n' +
    //     '\n' +
    ...
    //     'Uvedené symptómy vo všetkých troch komponentoch syndrómu balbuties potvrdzujú diagnózu fixovaná zajakavosť.\n' +
    //     '\n' +
    //     'TERAPIA \n' +
    ...
    //     'vlastná identifikácia príznakov neplynulostí v reči ( u dieťaťa, keďže si už svoju zajakavosť uvedomuje ), vytvoriť reálnu spätnú väzbu dieťaťa na svoju fluenciu / dysfluenciu – základ pre vznik kontroly nad rečou / plynulosťou, preventívne opatrenia  voči dysfukčnému copingu týkajúce sa percipovania problému\n' +
    ...
    //     'v neskorších fázach terapeutického procesu udržiavanie a event. zlepšovanie novonadobudnutej plynulosti reči v rolových hrách, skupinová terapia na udržanie motivácie dieťaťa k terapii zajakavosti, príprava na transfer novonadobudnutej plynulosti reči a imunizácia voči obavám z verbálnej komunikácie dieťaťa v podmienkach bežného života\n' +
    ...
    //     'V oblasti psychickej tenzie sa vyhýbavé správanie vzhľadom na obávané slová začínajúce na okluzívy zlepšilo, zotrváva však v situáciách v kontakte s cudzími ľuďmi a v niektorých situáciách v školskom prostredí (odporúčame psychologickú intervenciu resp. psychoterapiu). Manipulácia s oblečením a predmetmi počas komunikácie ako prejav psychickej tenzie v porovnaní pred začatím terapie a po absolvovaní terapeutického procesu skoro úplne vymizla, stupeň sa znížil z 3 na 1. Udržiavanie zrakového kontaktu zaznamenalo taktiež výraznú zmenu zo stupňa 3 na 1.\n' +
    //     '\n' +
    //     'ZHRNUTIE VÝSLEDKOV\n' +
    //     '     Z komplexného hľadiska možno konštatovať zlepšenie symptomatiky vo všetkých oblastiach klinického obrazu zajakavosti.\n' +
    //     '\n' +
    //     '     Z kvantitatívneho hľadiska klesol počet príznakov v oblasti dysfluencií – najvýraznejší pokles zaznamenali prolongácie. V oblasti nadmernej námahy sa zmiernil jej stupeň z 3 na 1. V oblasti psychickej tenzie možno taktiež konštatovať zmenu stupňa z 3 na 1.\n' +
    //     '\n' +
    ...
    //     '\n' +
    //     'ZÁVER\n' +
    //     '     Snažili sme sa naznačiť, že terapeutický proces u detí s FZ nekončí administrovaním pracovných listov ( po 3 - 6 mesiacoch trvania terapie zajakavosti, ale pokračuje udržiavaním novo-nadobudnutej plynulosti reči dieťaťa a jej transferom do bežného života ( do prostredia mimo logopedickej ambulancie – intenzita terapeutických stretnutí má tendenciu sa postupne znižovať t.j. 1- krát za 2 týždne, neskôr 1 – krát za mesiac, neskôr sa mení na katamnestické / postterapuetické kontroly ). Tento proces trvá približne 2 roky a samozrejme podľa potreby aj dlhšie časové obdobie v závislosti od druhu a stupňa rozvinutia syndrómu balbuties.'
}